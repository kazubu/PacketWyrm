...
module pw_csr_full #(
    ...
    input  wire [31:0]       rx_unmatched_i       [NUM_PORTS],
    input  wire [31:0]       last_unmatched_ctx_i [NUM_PORTS],
    input  wire [31:0]       last_unmatched_fid_i [NUM_PORTS],
    ...
    pw_stats_snapshot #(
        ...
        .rx_unmatched_i       (rx_unmatched_i),
        .last_unmatched_ctx_i (last_unmatched_ctx_i),
        .last_unmatched_fid_i (last_unmatched_fid_i),
        .flow_rx_i      (flow_rx_i),
