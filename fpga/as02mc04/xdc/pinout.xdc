...
############################################################
# J5 header GPIO - cross-card time-sync (pw_gpio_sync).
#
# 6 LVCMOS33 signals, each on a J5 odd/even pin pair. Bidirectional (IOBUF in
# the board top); only the CSR-configured sync-out pin is driven, the rest are
# hi-Z. Async inputs are synchronised in pw_gpio_sync and false-pathed below.
#
