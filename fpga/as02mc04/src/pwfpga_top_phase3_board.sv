...
module pwfpga_top_phase3_board (
    ...
    wire clk_125mhz, mmcm_fb, mmcm_lock, clk125_u, fb_u;
    MMCME4_BASE #(.CLKIN1_PERIOD(10.000), .CLKFBOUT_MULT_F(12.500),
                  .DIVCLK_DIVIDE(1), .CLKOUT0_DIVIDE_F(10.000)) u_mmcm (
    ...
    wire [63:0] ts;
    pw_timestamp u_ts (.clk(axi_aclk), .rst_n(axi_aresetn), .ts_o(ts));
    ...
    pwfpga_top_phase3 #(
        ...
        .clk(axi_aclk), .rst_n(axi_aresetn),
